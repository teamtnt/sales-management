...
// Lead Notes
Route::get('/lead-notes/{lead:id}/notes', [LeadNotesController::class, 'fetchLeadNotes'])->name('fetch-lead-notes');
...
Route::group(['middleware' => ['can:'.config('sales-management.permission_prefix').'.view-campaigns'  ]], function () {
    ...
    Route::delete('/campaign/{campaign}/lead/{lead}', [LeadsController::class, 'destroy'])->name('lead.destroy');
