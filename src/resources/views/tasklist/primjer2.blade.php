...
@section('content')
    ...
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">Provjeriti imaju li kontakti backlink</h1>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5 class="card-title">Kontakti za provjeru</h5>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5 class="card-title">Ima Backlink</h5>
                        <h6 class="card-subtitle text-muted">Nam pretium turpis et arcu. Duis arcu.</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-12 col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5 class="card-title">Nema Backlink</h5>
                        <h6 class="card-subtitle text-muted">Nam pretium turpis et arcu. Duis arcu.</h6>
                    </div>
                    <div class="card-body">
