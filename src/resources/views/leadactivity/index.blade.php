        ...
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() {
                ...
                document.getElementById('apply-filters-btn').addEventListener('click', function() {
                    var ownerFilter = document.getElementById('owner_filter') ? document
                        .getElementById('owner_filter').value : '';
                    var dateFrom = document.getElementById('date_from') ? document.getElementById(
                        'date_from').value : '';
                    var dateTo = document.getElementById('date_to') ? document.getElementById(
                        'date_to').value : '';
