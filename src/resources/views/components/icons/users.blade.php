{{--<svg {{ $attributes->merge(['class' => '']) }} fill="currentColor" version="1.1" id="Capa_1" width="24px" height="24px"--}}
...
{{--</g>--}}
{{--</svg>--}}
<svg {{ $attributes->merge(['class' => '']) }} fill="none" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor"
     stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users align-middle me-2"><path
