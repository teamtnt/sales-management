        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{ Form::open(['method' => 'post', 'route' => 'teamtnt.sales-management.companies.store']) }}

                        @include('sales-management::companies.fields')

                        <div class="my-3">
                            <button type="submit" class="btn btn-success me-2"
                                    id="notyf-show">{{__("Create Company")}}</button>
                             <a href="{{ route('teamtnt.sales-management.companies.index') }}" class="btn btn-danger">{{__("Cancel")}}</a>
                         </div>
                        {{ Form::close() }}
                    </div>
                </div>
